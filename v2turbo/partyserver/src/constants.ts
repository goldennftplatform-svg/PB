...
/** Jackpot wallet = tax recipient (same wallet: receives tax + SOL, payouts from here) */
...
export const DRIP_MIN_BALANCE_RAW = "10000000";
export const DRIP_PERCENT_BPS = "1000";
export const DRIP_MAX_CHUNK_RAW = "100000000";
export const DRIP_RANDOM_MIN = "80";
export const DRIP_RANDOM_MAX = "120";
